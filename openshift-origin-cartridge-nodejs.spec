...
%if 0%{?fedora}%{?rhel} <= 6
  %global scl feedhenry
  %global scl_prefix feedhenry-
%endif

%global cartridgedir %{_libexecdir}/openshift/cartridges/feedhenry

Summary:       Provides FeedHenry Support to a running Node.js application
Name:          openshift-origin-cartridge-feedhenry
Version: 1.31.1
Release:       1%{?dist}
...
Provides:      openshift-origin-cartridge-feedhenry-0.6 = 2.0.0
Obsoletes:     openshift-origin-cartridge-feedhenry-0.6 <= 1.99.9
BuildArch:     noarch

%description
Provides FeedHenry support to running Node.js applications in OpenShift. (Cartridge Format V2)
